...
-- profile_id is fixed as 'bb7e1f38-9324-4ee4-877c-8e71b2d7a96a'
-- 1. playlists
INSERT INTO
    playlists (
        title,
...
VALUES
    (
        ...
        true,
        '{"views":0,"likes":0}',
        'bb7e1f38-9324-4ee4-877c-8e71b2d7a96a',
        now (),
        now ()
    ),
    (
...
VALUES
    ...
    (
        ...
        'event bubbling은 이벤트가 발생한 요소에서 부모 요소로 이벤트가 전파되는 과정입니다.',
        '{"views":0,"likes":0}',
        'bb7e1f38-9324-4ee4-877c-8e71b2d7a96a',
        now (),
        now ()
    ...
    (
        ...
        'event capturing은 이벤트가 발생한 요소에서 부모 요소로 이벤트가 전파되는 과정입니다.',
        '{"views":0,"likes":0}',
        'bb7e1f38-9324-4ee4-877c-8e71b2d7a96a',
        now (),
        now ()
    ...
    (
        ...
        'event delegation은 이벤트가 발생한 요소에서 부모 요소로 이벤트가 전파되는 과정입니다.',
        '{"views":0,"likes":0}',
        'bb7e1f38-9324-4ee4-877c-8e71b2d7a96a',
        now (),
        now ()
    ...
    (
        ...
        'event propagation은 이벤트가 발생한 요소에서 부모 요소로 이벤트가 전파되는 과정입니다.',
        '{"views":0,"likes":0}',
        'bb7e1f38-9324-4ee4-877c-8e71b2d7a96a',
        now (),
        now ()
    ...
    (
        ...
        'any와 unknown의 차이점은 any는 모든 타입을 허용하지만, unknown은 모든 타입을 허용하지 않습니다.',
        '{"views":0,"likes":0}',
        'bb7e1f38-9324-4ee4-877c-8e71b2d7a96a',
        now (),
        now ()
